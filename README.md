...
### Getting Started
It is recommened to use SBT 0.10.x or higher for this plugin to work correctly, although it will probably work for earlier versions since it was originally developed for sbt 0.13.6.
It was lasted tested with SBT 0.10.7
...
If you want to use one of the existing themes, like the "Scalapenos" theme shown at the top of this README, just add the following import and setting to your `build.sbt` file (or to any sbt file in `~/.sbt/1.0/`):
